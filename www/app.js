(function (angular) {
    ...
    function configFN($stateProvider,$urlRouterProvider,$locationProvider,$httpProvider, jwtOptionsProvider,$provide) {
    ...
    configFN.$inject = ['$stateProvider','$urlRouterProvider','$locationProvider','$httpProvider', 'jwtOptionsProvider','$provide'];
    angular.module('app',['ionic','ui.router','duScroll','ngResource','angularLoad','angular-jwt','yaru22.angular-timeago','ngMap','facebook','angularFileUpload','cgBusy'
    ]).config(configFN);
}
)(angular);